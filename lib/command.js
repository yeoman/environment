...
module.exports = cls => class extends cls {
  ...
  async execute(generatorNamespace, args = []) {
    ...
    const generator = this.create(namespace.namespace, {help: true});
    namespaceCommand.addGeneratorOptions(generator._options);
    namespaceCommand.addGeneratorArguments(generator._arguments);
