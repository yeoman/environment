...
const debug = createdLogger('yeoman:environment:features');

const generatorFeaturesMixin = cls =>
  class extends cls {
    /**
     * @private
    ...
    getGeneratorsFeatures() {
      return Object.fromEntries(
        Object.entries(this.getAllGenerators()).map(([namespace, generator]) => [
          namespace,
          (generator.getFeatures ? generator.getFeatures() : {}) || {},
        ]),
      );
    }
    ...
    getGeneratorsFeature(featureName) {
      return Object.fromEntries(
        Object.entries(this.getGeneratorsFeatures())
