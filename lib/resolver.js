...
resolver.findGeneratorsIn = function (searchPaths) {
  ...
  for (const root of searchPaths) {
    ...
    try {
      ...
      // To limit recursive lookups into non-namespace folders within globby, fetch all namespaces in root, then search each namespace separately for a generator modules
