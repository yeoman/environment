...
resolver.lookup = function (options = {localOnly: false}, cb) {
  ...
  const generatorsModules = this.findGeneratorsIn(options.npmPaths, options);
 ...
 * @param {boolean} [options.skipRepositoryScan=false] - Don't look for packages at npmPaths childs.
