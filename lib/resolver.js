...
resolver.lookup = function (options = {localOnly: false}, cb) {
  ...
  const generatorsModules = this.findGeneratorsIn(npmPaths, options.packagePatterns);
 ...
 * @param {boolean} [packagePatterns='generator-*'] - Package pattern.
 * @return {Array} List of the generator modules path
 */
resolver.findGeneratorsIn = function (searchPaths, packagePatterns = 'generator-*') {
