 ...
 * @param {string|Array} [options.filePattern='*\/index.js'] - File pattern to look for.
 * @param {string|Array} [options.packagePattern='generator-*'] - Package pattern to look for.
