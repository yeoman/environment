...
class Environment extends Base {
    ...
    const promise = new Promise((resolve, reject) => {
      if (this.conflicter === undefined) {
        this.conflicter = new Conflicter(this.adapter, generator.options.force, {
          ...
          skipYoResolve: this.options.skipYoResolve || generator.options.skipYoResolve,
          cwd: this.options.logCwd || generator.options.logCwd
        });
   ...
   * @return {Promise}
   */
  applyTransforms(transformStreams, stream = this.sharedFs.stream()) {
    ...
    return pipeline(
      ...
      ...transformStreams,
      createEachFileTransform({autoForward: false}));
  }
