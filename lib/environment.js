 ...
 * @param {String}       namespace
 * @param {Object}       options
 * @param {Array}        options.arguments  Arguments to pass the instance
...
Environment.prototype.instantiate = function instantiate(Generator, options) {
  ...
  var args = options.arguments || _.clone(this.arguments);
...
/**
 * Factory method to create an environment instance
 */
