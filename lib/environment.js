...
const composability = require('./composability.js');
const resolver = require('./resolver.js');
const TerminalAdapter = require('./adapter');
const YeomanRepository = require('./util/repository.js');
const Conflicter = require('./util/conflicter.js');
const { YeomanCommand } = require('./util/command.js');
const { toNamespace } = require('./util/namespace.js');
const {
...
const mixins = [require('./command.js'), require('./generator-features.js'), require('./package-manager.js')];
