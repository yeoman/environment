...
import { type Stream, type Transform } from 'node:stream';
import { type ExecaChildProcess, type ExecaSyncReturnValue, type Options as ExecaOptions, type SyncOptions } from 'execa';
...
declare class Environment<TOptions extends EnvironmentOptions = EnvironmentOptions> extends EventEmitter implements BaseEnvironment {
   ...
   * @returns The newly created environment.
   */
  static createEnvWithVersion<TOptions extends EnvironmentOptions>(
    version: string,
    args?: string | string[],
    options?: TOptions,
    adapter?: InputOutputAdapter,
   ...
   */
  static lookupGenerator(namespace: string, options?: ArrayGeneratorLookupOptions): string[];
   ...
   */
  static lookupGenerator(namespace: string, options?: SingleGeneratorLookupOptions): string;
   ...
   */
  error(error: Error | Record<string, unknown>): Error;
   ...
   */
  findGeneratorsIn(list: string[], options?: GeneratorsInOptions): string[];
   ...
   * @deprecated
   */
  getNpmPaths(options?: NpmPathsOptions): string[];
   ...
   */
  loadEnvironmentOptions(options: EnvironmentOptions): EnvironmentOptions;
   ...
   */
  loadSharedOptions(options: GeneratorBaseOptions): GeneratorBaseOptions;
   ...
   * @param options The options to pass to the generator.
   */
  run(args: string | [string, ...string[]], options?: GeneratorBaseOptions): Promise<void>;
   ...
   */
  start(options: ConflicterOptions): Promise<void>;
   ...
   */
  spawnCommand(command: string, args: string[], options: ExecaOptions): ExecaChildProcess;
 ...
 */
export type InstantiateOptions<TOptions extends GeneratorBaseOptions = GeneratorBaseOptions> = {
  /**
 ...
 */
export type GeneratorLookupOptions = {
  /**
 ...
 */
export type SingleGeneratorLookupOptions = {
  /**
   * @inheritdoc
   */
  singleResult: true;
 ...
 */
export type ArrayGeneratorLookupOptions = {
  /**
   * @inheritdoc
   */
 ...
 */
export type GeneratorsInOptions = {
  /**
   * The package-patterns to look for.
   */
  packagePatterns?: string[] | undefined;
